...
export const HOW = [
  {
    step: "01",
    title: "Import",
    body: "Drop in years of records — PDFs, prescription photos, imaging reports. Vision-based extraction pulls the structured clinical entities from each one.",
  },
  {
    step: "02",
    title: "Remember",
  ...
  },
  {
    step: "04",
    title: "Evolve",
    body: "Each new upload enriches prior records. Ruled-out findings are removed from the active view — the memory keeps sharpening.",
  },
] as const;
...
export const ADVANTAGES = [
  ...
  },
  {
    ...
    body: "Every memory update is a visible, traceable step, with the evidence chain shown — not a black box.",
  },
  {
    title: "It compounds",
...
export const FAQ = [
  ...
  },
  {
    ...
    a: "Uploaded documents pass through vision-based extraction, which pulls structured clinical entities — diagnosis, medication, dose, lab value, date. Those entities, not the raw file, become the memory.",
  },
  {
    q: "What happens when information is wrong or outdated?",
    a: "You correct or retire it. A ruled-out diagnosis or discontinued medication is removed from the active summary while remaining in the historical record — recoverable, auditable, never silently deleted.",
  },
  {
    q: "Who can see a patient's record?",
    a: "Only clinicians in the same clinic, with every access and correction attributed and logged. Patients don't yet have a login of their own — that's on the roadmap.",
  },
] as const;
